...
export function ProjectCard({
  ...
  return (
    <div
      className={cn(
        "group overflow-hidden rounded-[1.5rem] border border-[var(--color-border)] bg-[var(--color-card-bg)] shadow-[0_24px_80px_var(--color-shadow)] backdrop-blur-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_30px_90px_var(--color-shadow)]",
        isMuted && "opacity-80"
      )}
    >
      <div className="grid gap-8 px-6 py-8 lg:grid-cols-[0.95fr_1.05fr] lg:items-start">
        <div className="space-y-6">
          <div className="space-y-3">
            <p className="uppercase tracking-[0.24em] text-xs font-semibold text-[var(--color-accent)]">
              Project
            </p>
            <h3 className="text-3xl font-semibold leading-tight text-[var(--color-text-primary)]">
              {project.name}
            </h3>
          ...
          <button
            ...
            className="inline-flex items-center gap-2 rounded-full border border-[var(--color-border-strong)] bg-[var(--color-surface)] px-5 py-2 text-sm font-semibold text-[var(--color-text-primary)] transition hover:border-[var(--color-accent)] hover:bg-[var(--color-accent-soft)]"
          >
        ...
        <div className="relative flex items-center justify-center rounded-[1rem] border border-[var(--color-border)] bg-[var(--color-surface)] p-6 shadow-[inset_0_0_0_1px_rgba(255,255,255,0.55)]">
          <div className="absolute inset-x-6 top-6 h-5 rounded-full bg-[var(--color-border)]/50 blur-sm" />
          <div className="relative h-full w-full rounded-[1rem] border border-[var(--color-border-strong)] bg-[var(--color-bg)] p-5 shadow-[0_16px_40px_rgba(15,23,42,0.08)]">
      ...
      <AnimatePresence initial={false}>
        {expanded && (
          <motion.div
            ...
            className="overflow-hidden border-t border-[var(--color-border)] bg-[var(--color-surface)] px-6 py-10"
          >
